...
db.set(`Root`,`Ewing Botun Sahibi.`)
...
db.set(`Ewing`,`Bu oyunu oynadığınız botun ismi.`)
...
//Amil <3 ///////////////////
      var kelimeler = ['Klostrofobi','Türkçe','Domates','Root','Otel','Söğüt','Veteriner','Ewing','Rythm','Magnum','Lüksemburg','Deve'];
...
if (!message.author.bot) { 
              ...
              console.log('root-user\'adamdır') //burayı silende ne bilim.
